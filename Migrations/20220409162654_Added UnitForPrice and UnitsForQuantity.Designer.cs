...
namespace FYP_AgroNepalTrade.Migrations
{
    ...
    [Migration("20220409162654_Added UnitForPrice and UnitsForQuantity")]
    partial class AddedUnitForPriceandUnitsForQuantity
    {
            ...
            modelBuilder.Entity("FYP_AgroNepalTrade.Models.ProductViewModels.Product", b =>
                {
                    ...
                    b.Property<string>("UnitsForPrice")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UnitsForQuantity")
                        .HasColumnType("nvarchar(max)");
